package DBIC::ResultSourceProxy::Table;

use strict;
use warnings;

use base qw/DBIC::ResultSourceProxy/;

use DBIC::ResultSource::Table;
use Scalar::Util 'blessed';
use namespace::clean;

__PACKAGE__->mk_classdata(table_class => 'DBIC::ResultSource::Table');
...
DBIC::ResultSourceProxy::Table - provides a classdata table
...
=head2 table_class
  ...
  __PACKAGE__->table_class('DBIC::ResultSource::Table');
...
L<DBIC::ResultSource/add_column>
