...
DBIC::CDBICompat::ColumnsAsHash - Emulates the behavior of Class::DBI where the object can be accessed as a hash of columns.
...
sub _make_columns_as_hash {
    ...
    for my $col ($self->columns) {
        ...
        tie $self->{$col}, 'DBIC::CDBICompat::Tied::ColumnValue',
            $self, $col;
    }
}


package DBIC::CDBICompat::Tied::ColumnValue;
