...
DBIC::SQLMaker::ClassicExtensions - Class containing generic enhancements to SQL::Abstract::Classic
...
a DBIC::SQLMaker-like provider. See
L<DBIC::Storage::DBI/connect_call_rebase_sqlmaker> for more info.
...
sub throw_exception { DBIC::Exception->throw($_[1]) }
