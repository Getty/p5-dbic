...
Overrides DBIC::SQLMaker's select() method, which calls _oracle_joins()
...
=item L<DBIC::Storage::DBI::Oracle::WhereJoins> - Storage class using this

=item L<DBIC::SQLMaker> - Parent module
