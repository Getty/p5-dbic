...
use DBIC::ClassResolver::PassThrough;
use DBI;
use Scalar::Util 'blessed';
use namespace::clean;

unless ($INC{"DBIC/CDBICompat.pm"}) {
  warn "IMPORTANT: DBIC::DB is DEPRECATED AND *WILL* BE REMOVED. DO NOT USE.\n";
}
...
DBIC::DB - (DEPRECATED) classdata schema component

=head1 DESCRIPTION

This class is designed to support the Class::DBI connection-as-classdata style
for DBIC. You are *strongly* recommended to use a DBIC::Schema
instead; DBIC::DB will not undergo new development and will be moved
...
Sets or gets the storage backend. Defaults to L<DBIC::Storage::DBI>.
...
L<DBIC::ClassResolver::Passthrough>, which returns whatever you give
...
Creates a class method ->schema_instance which contains a DBIC::Schema;
all class-method operations are proxies through to this object. If you don't
call ->connection in your DBIC::DB subclass at load time you *must*
...
is rethrown. See L<DBIC::Schema/"txn_do"> for more details.
...
native L<DBIC::ResultSet> system.
...
# (with good reason) DBIC::Schema copies the result source for
