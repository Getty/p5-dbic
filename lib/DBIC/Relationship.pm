...
See L<DBIC::Manual::Cookbook> for more.

=head1 DESCRIPTION

The word I<Relationship> has a specific meaning in DBIC, see
the definition in the L<Glossary|DBIC::Manual::Glossary/Relationship>.
...
technique that L<DBIC> provides. To create efficient database queries,
...
L<Result|DBIC::Manual::Glossary/"Result"> objects that represent the items
of your table. From L<ResultSet|DBIC::Manual::Glossary/"ResultSet"> objects,
...
See L<DBIC::Relationship::Base/condition> for full documentation on
...
L<Result|DBIC::Manual::ResultClass> object to retrieve the instance of the foreign
class matching this relationship. This is often called the
C<relation(ship) name>.

Use this accessor_name in L<DBIC::ResultSet/join>
or L<DBIC::ResultSet/prefetch> to join to the foreign table
...
more info see L<DBIC::Relationship::Base/condition>.
...
L<nullable|DBIC::ResultSource/is_nullable> you probably want to set
the L<join_type|DBIC::Relationship::Base/join_type> attribute to
...
L<join|DBIC::ResultSet/join> or
L<prefetch|DBIC::ResultSet/prefetch>).
...
for a L<list of standard resultset attributes|DBIC::ResultSet/ATTRIBUTES>
...
=item Arguments: $accessor_name, $related_class, $their_fk_column|\%cond|\@cond|\&cond?, L<\%attrs?|DBIC::ResultSet/ATTRIBUTES>
...
This argument is the name of the method you can call on a
L<Result|DBIC::Manual::ResultClass> object to retrieve a resultset of the related
...
L<DBIC::Relationship::Base/"create_related">.
...
See L<DBIC::Relationship::Base/attributes> for documentation on
relationship methods and valid relationship attributes. Also see
L<DBIC::ResultSet> for a L<list of standard resultset
attributes|DBIC::ResultSet/ATTRIBUTES> which can be assigned to
...
you probably just meant to use C<DBIC::Relationship/belongs_to>.
...
L<DBIC::Relationship/might_have> relationship.
...
L<DBIC::Relationship/might_have>.

=head2 many_to_many

=over 4

=item Arguments: $accessor_name, $link_rel_name, $foreign_rel_name, L<\%attrs?|DBIC::ResultSet/ATTRIBUTES>

=back

C<many_to_many> is a I<Relationship bridge> which has a specific
meaning in DBIC, see the definition in the
L<Glossary|DBIC::Manual::Glossary/Relationship bridge>.
...
This argument is the name of the method you can call on a
L<Result|DBIC::Manual::ResultClass> object to retrieve the rows matching this
relationship.

On a many_to_many, unlike other relationships, this cannot be used in
L<DBIC::ResultSet/search> to join tables. Use the relations
