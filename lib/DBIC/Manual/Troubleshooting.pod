...
DBIC::Manual::Troubleshooting - Got a problem? Shoot it.
...
columns to fail with a message such as:
  ...
  Can't get last insert id at /.../DBIC/Row.pm line 95
...
L<DBIC::Manual::Cookbook/Setting quoting for the generated SQL> for
details.
...
There is a problem with slow performance of certain DBIC
...
degradation exponential to the number of L<DBIC> result objects in
...
of the bless/overload problem can be found in the L<DBIC> test
...
It has been observed, using L<DBD::ODBC>, that creating a L<DBIC::Row>
