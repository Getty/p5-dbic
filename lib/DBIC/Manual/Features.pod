# PODNAME: DBIC::Manual::Features
# ABSTRACT: A boatload of DBIC features with links to respective documentation

=head1 META

=head2 Large Community

There are L<hundres of DBIC contributors|DBIC/AUTHORS> listed in
...
L<ebbs and flows|https://metacpan.org/changes/distribution/DBIC>.)
...
See L<DBIC::ResultSet/find>, L<DBIC::ResultSet/search>, L<DBIC::ResultSet/next>, and L<DBIC::ResultSet/all>
...
=item See L<SQL::Abstract>, L<DBIC::ResultSet/next>, and L<DBIC::ResultSet/search>
...
=item L<DBIC::ResultSet/find_or_create>

=item L<DBIC::ResultSet/update_or_create>
...
=item L<DBIC::Relationship/belongs_to>

=item L<DBIC::Relationship/has_many>

=item L<DBIC::Relationship/might_have>

=item L<DBIC::Relationship/has_one>

=item L<DBIC::Relationship/many_to_many>
...
Create a database from your DBIC schema.

 my $schema = Frew::Schema->connect( $dsn, $user, $pass );

 $schema->deploy

See L<DBIC::Schema/deploy>.

See also: L<DBIC::DeploymentHandler>

=head2 Schema::Loader

Create a DBIC schema from your database.
...
See L<DBIC::Schema::Loader> and L<DBIC::Schema::Loader::Base/CONSTRUCTOR OPTIONS>.
...
DBIC helped pioneer fast MI in Perl 5 with Class::C3, so it is made to
allow extensions to nearly every part of it.

=head2 Extensibility example: DBIC::Helpers

=over 1

=item L<DBIC::Helper::ResultSet::IgnoreWantarray>

=item L<DBIC::Helper::ResultSet::Random>

=item L<DBIC::Helper::ResultSet::SetOperations>

=item L<DBIC::Helper::Row::JoinTable>

=item L<DBIC::Helper::Row::NumifyGet>

=item L<DBIC::Helper::Row::SubClass>

=item L<DBIC::Helper::Row::ToJSON>

=item L<DBIC::Helper::Row::StorageValues>

=item L<DBIC::Helper::Row::OnColumnChange>

=back

=head2 Extensibility example: DBIC::TimeStamp

=over 1

=item See L<DBIC::TimeStamp>
...
=item See L<DBIC::Schema::KiokuDB>
...
See L<DBIC::Manual::Cookbook/Predefined searches>
...
=item L<DBIC::ResultSet/current_source_alias> helps things to work no matter what
...
See: L<DBIC::ResultSet/related_resultset>,
L<DBIC::ResultSet/search_related>, and
L<DBIC::ResultSet/get_column>.
...
See L<DBIC::Relationship::Base/create_related> and L<DBIC::Relationship::Base/add_to_$rel>
...
See L<DBIC::Schema/txn_do>, L<DBIC::Schema/txn_begin>,
and L<DBIC::Schema/txn_commit>.
...
See L<DBIC::InflateColumn>, L<DBIC::InflateColumn/inflate_column>, and
...
See L<DBIC::FilterColumn> and L<DBIC::FilterColumn/filter_column>
...
See L<DBIC::ResultSet/select>, L<DBIC::ResultSet/as>, and
L<DBIC::ResultSet/group_by>
...
See L<DBIC::ResultSet/result_class> and L<DBIC::ResultClass::HashRefInflator>.
...
See L<DBIC::Manual::Cookbook/Subqueries>
