...
DBIC::Manual::Features - A boatload of DBIC features with links to respective documentation
...
=item See L<SQL::Abstract::Classic>, L<DBIC::ResultSet/next>, and L<DBIC::ResultSet/search>
