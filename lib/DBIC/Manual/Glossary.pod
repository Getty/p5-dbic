...
DBIC::Manual::Glossary - Clarification of terms used.

=head1 INTRODUCTION

This document lists various terms used in DBIC and attempts to
explain them.
...
to objects in programming-language-space. DBIC is an ORM.

=head2 Relationship

In DBIC a relationship defines the connection between exactly
...
At least one L<DBIC::Schema> class is needed per database.
...
in your application, they should inherit from L<DBIC::Core>.

See also: L<DBIC::Manual::ResultClass>
...
See also: L<DBIC::ResultSource/METHODS>
...
See also: L<DBIC::ResultSet/METHODS>
...
can be found in L<the FAQ|DBIC::Manual::FAQ>.
