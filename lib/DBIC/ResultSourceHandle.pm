...
L<ResultSources|DBIC::ResultSource> (which may contain unserializable
elements like C<CODE> references).

Originally this module was used to remove the fixed link between
L<Rows|DBIC::Row>/L<ResultSets|DBIC::ResultSet> and the actual
L<result source objects|DBIC::ResultSource> in order to obviate the need
of keeping a L<schema instance|DBIC::Schema> constantly in scope, while
...
sub resolve {
  ...
  $_[0]->_detached_source || DBIC::Exception->throw( sprintf (
