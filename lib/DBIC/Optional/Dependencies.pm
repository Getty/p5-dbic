...
my $reqs = {
  replicated => {
    ...
    pod => {
      ...
      desc => 'Modules required for L<DBIC::Storage::DBI::Replicated>',
    },
  },
  ...
  deploy => {
    ...
    pod => {
      ...
      desc => 'Modules required for L<DBIC::Storage::DBI/deployment_statements> and L<DBIC::Schema/deploy>',
    },
  },
...
sub _gen_pod {
  ...
  $distver ||=
    eval { require DBIC; DBIC->VERSION; }
      ||
    die
"\n\n---------------------------------------------------------------------\n" .
'Unable to load core DBIC module to determine current version, '.
...
Somewhere in your build-file (e.g. L<Module::Install>'s Makefile.PL):
  ...
  configure_requires 'DBIC' => '$distver';
...
EOS
    '=head1 DESCRIPTION',
    <<'EOD',
Some of the less-frequently used features of L<DBIC> have external
...
of such dependencies, for DBIC core authors, and DBIC extension
authors alike.
EOD
...
EOD
  ...
  push @chunks, (
    ...
    '=back',
    <<'EOD',
This method should be used by DBIC packagers, to get a hashref of all
...
EOD
    ...
    '=back',
    <<'EOD',
This method should be used by DBIC extension authors, to determine the
version of modules a specific feature requires in the B<current> version of
DBIC. See the L</SYNOPSIS> for a real-world
example.
EOD
...
This method would normally be used by DBIC core-module author, to
