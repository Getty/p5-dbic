...
DBIC::SQLMaker - An SQL::Abstract::Classic-like SQL maker class

=head1 DESCRIPTION

This module serves as a mere "nexus class" providing
L<SQL::Abstract::Classic>-like functionality to L<DBIC> itself, and
...
L<SQLMaker rebase|DBIC::Storage::DBI/connect_call_rebase_sqlmaker>
...
|https://github.com/Perl5/DBIC/blob/master/lib/DBIC/Storage/DBIHacks.pm>
...
functionality|https://github.com/Perl5/DBIC/blob/7ef1a09ec4/lib/DBIC/Storage/DBIHacks.pm#L373-L396>
