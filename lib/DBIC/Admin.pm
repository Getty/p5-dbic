...
BEGIN {
  use DBIC;
  die('The following modules are required for DBIC::Admin ' . DBIC::Optional::Dependencies->req_missing_for ('admin') )
...
use DBIC::Admin::Types qw/DBICConnectInfo DBICHashRef/;
...
install is here to help when you want to move to L<DBIC::Schema::Versioned> and have an existing
