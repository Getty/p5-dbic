package DBIC::Storage::DBI::SQLAnywhere;

use strict;
use warnings;
use base qw/DBIC::Storage::DBI::UniqueIdentifier/;
use mro 'c3';
use Try::Tiny;
use namespace::clean;
...
__PACKAGE__->cursor_class('DBIC::Storage::DBI::SQLAnywhere::Cursor');

=head1 NAME

DBIC::Storage::DBI::SQLAnywhere - Driver for SQL Anywhere

=head1 DESCRIPTION

This class implements autoincrements for SQL Anywhere and provides
L<DBIC::InflateColumn::DateTime> support and support for the
C<uniqueidentifier> type (via
L<DBIC::Storage::DBI::SQLAnywhere::Cursor>.)
...
Recommended L<connect_info|DBIC::Storage::DBI/connect_info> settings:
...
sub select_single {
  ...
  return @row
    unless $self->cursor_class->isa('DBIC::Storage::DBI::SQLAnywhere::Cursor');
...
A L<DBIC> application can use a lot of cursors, due to the usage of
