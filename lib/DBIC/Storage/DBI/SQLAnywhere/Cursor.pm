package DBIC::Storage::DBI::SQLAnywhere::Cursor;
...
DBIC::Storage::DBI::SQLAnywhere::Cursor - GUID Support for SQL Anywhere
...
L<DBIC::Storage::DBI::SQLAnywhere> for information on the SQL Anywhere
driver.
...
L<DBIC::Storage::DBI::SQLAnywhere> sets
