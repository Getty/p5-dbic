package DBIC::Storage::DBI::ODBC::ACCESS;
...
DBIC::Storage::DBI::ODBC::ACCESS - Support specific to MS Access over ODBC

=head1 DESCRIPTION

This class implements support specific to Microsoft Access over ODBC.

It is a subclass of L<DBIC::Storage::DBI::ODBC> and
L<DBIC::Storage::DBI::ACCESS>, see those classes for more
information.

It is loaded automatically by L<DBIC::Storage::DBI::ODBC> when it
detects a MS Access back-end.

This driver implements workarounds for C<IMAGE> and C<MEMO> columns, and
L<DBIC::InflateColumn::DateTime> support for C<DATETIME> columns.
...
drivers (like L<ADO|DBIC::Storage::DBI::ADO::MS_Jet>) will automatically
...
L<connect_info|DBIC::Storage::DBI/connect_info>; but if you set this
...
sub datetime_parser_type {
  'DBIC::Storage::DBI::ODBC::ACCESS::DateTime::Format'
}
