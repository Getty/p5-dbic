...
L<data_type|DBIC::ResultSource/data_type>, as well as non-PK with
L<auto_nextval|DBIC::ResultSource/auto_nextval> set.
...
L<DBIC::Storage> reference as a parameter.
