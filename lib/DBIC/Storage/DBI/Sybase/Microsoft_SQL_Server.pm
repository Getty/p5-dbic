...
L<DBIC::Storage::DBI::Sybase::Microsoft_SQL_Server::NoBindVars>.
...
EOF
    require
      DBIC::Storage::DBI::Sybase::Microsoft_SQL_Server::NoBindVars;
    bless $self,
      'DBIC::Storage::DBI::Sybase::Microsoft_SQL_Server::NoBindVars';
    $self->_rebless;
  }
...
On connection for use with L<DBIC::InflateColumn::DateTime>
