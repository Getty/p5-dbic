...
with 'DBIC::Storage::DBI::Replicated::WithDSN';
...
for L<DBIC::Storage::DBI::Replicated> for more details.
...
L<DBIC::Storage::DBI::Replicated/is_replicating> and
L<DBIC::Storage::DBI::Replicated/lag_behind_master>.
