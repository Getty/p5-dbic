...
This role is used internally by L<DBIC::Storage::DBI::Replicated>.
...
L<DBIC::Storage::DBI::Replicated::Pool/validate_replicants>
...
The L<DBIC::Storage::DBI> object that is the master database all the
...
The L<DBIC::Storage::DBI::Replicated::Pool> object that we are trying to
balance.
...
your own subclasses of L<DBIC::Storage::DBI::Replicated::Balancer> to
