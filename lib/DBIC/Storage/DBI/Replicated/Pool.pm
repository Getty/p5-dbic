...
L<DBIC::Storage::DBI/lag_behind_master> method.  The default is 0.  In
...
need to subclass L<DBIC::Storage::DBI::Replicated::Replicant> you should
...
database, create an L<DBIC::Storage::DBI::Replicated::Replicant> object
...
## class to apply the Replicant role.
  ...
  DBIC::Storage::DBI::Replicated::Replicant->meta->apply($replicant);
...
See L<DBIC::Storage::DBI> for more about checking if a replicating
