...
DBIC::Storage::DBI::Replicated::Introduction - Minimum Need to Know

=head1 SYNOPSIS

This is an introductory document for L<DBIC::Storage::DBI::Replicated>.
...
L<DBIC> supports a framework for using database replication. This system
...
By default, when you start L<DBIC>, your Schema (L<DBIC::Schema>)
...
L<DBIC::Storage::DBI::mysql>  Your storage type class will contain
database specific code to help smooth over the differences between databases
and let L<DBIC> do its thing.
...
storage itself (L<DBIC::Storage::DBI::Replicated>).  A replicated storage
takes a pool of replicants (L<DBIC::Storage::DBI::Replicated::Pool>)
and a software balancer (L<DBIC::Storage::DBI::Replicated::Balancer>).
...
Then, you need to connect your L<DBIC::Schema>.

  $schema->connection($dsn, $user, $pass);

Let's break down the settings.  The method L<DBIC::Schema/storage_type>
...
replicated storage.  L<DBIC::Storage::DBI::Replicated/balancer_type> is
...
L<DBIC::Storage::DBI::Replicated::Balancer::First>,
L<DBIC::Storage::DBI::Replicated::Balancer::Random>.
...
This object (L<DBIC::Storage::DBI::Replicated::Pool>) manages all the
