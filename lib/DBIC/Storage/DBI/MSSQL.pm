...
__PACKAGE__->sql_maker_class('DBIC::SQLMaker::MSSQL');

__PACKAGE__->sql_quote_char([qw/[ ]/]);

__PACKAGE__->datetime_parser_type (
  'DBIC::Storage::DBI::MSSQL::DateTime::Format'
);
...
sub _select_args_to_query {
  ...
  if (
    ...
    $self->throw_exception(
      'An ordered subselect encountered - this is not safe! Please see "Ordered Subselects" in DBIC::Storage::DBI::MSSQL'
...
L<DBIC::Storage::DBI::ODBC::Microsoft_SQL_Server> and
...
L<has_many|DBIC::Relationship/has_many> relationship with limit/group
...
L<resultset attribute|DBIC::ResultSet/ATTRIBUTES> C<unsafe_subselect_ok>.
