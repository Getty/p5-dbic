...
L<auto_nextval|DBIC::ResultSource/auto_nextval>, savepoints and server
version detection.
...
__PACKAGE__->datetime_parser_type(
  'DBIC::Storage::DBI::InterBase::DateTime::Format'
);
...
greater, L<auto_nextval|DBIC::ResultSource/auto_nextval> however should
