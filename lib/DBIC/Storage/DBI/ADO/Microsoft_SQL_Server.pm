package DBIC::Storage::DBI::ADO::Microsoft_SQL_Server;
...
__PACKAGE__->cursor_class(
  'DBIC::Storage::DBI::ADO::Microsoft_SQL_Server::Cursor'
);

__PACKAGE__->datetime_parser_type (
  'DBIC::Storage::DBI::ADO::Microsoft_SQL_Server::DateTime::Format'
);
...
DBIC::Storage::DBI::ADO::Microsoft_SQL_Server - Support for Microsoft
...
with L<DBD::ADO>. See L<DBIC::Storage::DBI::MSSQL/IMPLEMENTATION NOTES>
...
(L<DBIC::Storage::DBI::ADO::Microsoft_SQL_Server::Cursor>) removes them,
...
(L<DBIC::Storage::DBI::ADO::Microsoft_SQL_Server::Cursor>) so that you
...
Fractional seconds with L<DBIC::InflateColumn::DateTime> are not
