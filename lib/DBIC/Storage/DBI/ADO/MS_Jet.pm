package DBIC::Storage::DBI::ADO::MS_Jet;

use strict;
use warnings;
use base qw/
  DBIC::Storage::DBI::ADO
  DBIC::Storage::DBI::ACCESS
/;
use mro 'c3';
use DBIC::Storage::DBI::ADO::CursorUtils '_normalize_guids';
use namespace::clean;

__PACKAGE__->cursor_class('DBIC::Storage::DBI::ADO::MS_Jet::Cursor');

=head1 NAME

DBIC::Storage::DBI::ADO::MS_Jet - Support for MS Access over ADO

=head1 DESCRIPTION

This driver is a subclass of L<DBIC::Storage::DBI::ADO> and
L<DBIC::Storage::DBI::ACCESS> for connecting to MS Access via
L<DBD::ADO>.

See the documentation for L<DBIC::Storage::DBI::ACCESS> for
information on the MS Access driver for L<DBIC>.

This driver implements workarounds for C<TEXT/IMAGE/MEMO> columns, sets the
L<cursor_class|DBIC::Storage::DBI/cursor_class> to
L<DBIC::Storage::DBI::ADO::MS_Jet::Cursor> to normalize returned
C<GUID> values and provides L<DBIC::InflateColumn::DateTime> support
...
L<problems|DBIC::Storage::DBI::ODBC::ACCESS/"TEXT/IMAGE/MEMO COLUMNS">
the L<ODBC|DBIC::Storage::DBI::ODBC::ACCESS> driver has with these types
...
L<ODBC|DBIC::Storage::DBI::ODBC::ACCESS> driver it is converted to
C<VARCHAR(255)>.
...
your L<connect_info|DBIC::Storage::DBI/connect_info>, it will be
multiplied by two and C<1> added, just as for the
L<ODBC|DBIC::Storage::DBI::ODBC::ACCESS> driver.
...
sub select_single {
  ...
  return @row unless
    $self->cursor_class->isa('DBIC::Storage::DBI::ADO::MS_Jet::Cursor');
...
sub datetime_parser_type {
  'DBIC::Storage::DBI::ADO::MS_Jet::DateTime::Format'
}
