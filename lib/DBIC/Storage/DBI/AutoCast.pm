...
As long as a column L<data_type|DBIC::ResultSource/add_columns> is
defined and resolves to a base RDBMS native type via
L<_native_data_type|DBIC::Storage::DBI/_native_data_type> as
...
L<connect_info|DBIC::Storage::DBI/connect_info> as:
...
in L<connect_info|DBIC::Storage::DBI/connect_info>.
