...
use DBIC::_Util qw(sigwarn_silencer qsub);
use IO::Handle ();
use Moo;
extends 'DBIC';
use namespace::clean;
...
This class is called by DBIC::Storage::DBI as a means of collecting
...
for collecting the statistics as discussed in L<DBIC::Manual::Cookbook>.

=head1 METHODS

=head2 new

Returns a new L<DBIC::Storage::Statistics> object.
...
L<DBIC_TRACE|DBIC::Storage/DBIC_TRACE> environment variable.
