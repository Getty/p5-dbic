...
DBIC::Manual - Index of the Manual

=head1 DESCRIPTION

This is the L<DBIC> users manual. DBIC is a SQL->OOP mapper.
...
=head2 L<DBIC::Manual::FAQ>

Short answers and doc pointers to questions.

=head2 L<DBIC::Manual::Glossary>

Explanations of terms used in this documentation.

=head2 L<DBIC::Manual::Intro>

Beginner guide to using DBIC.

=head2 L<DBIC::Manual::Example>

An example of slightly more complex usage.

=head2 L<DBIC::Manual::Joining>

How to translate known SQL JOINs into DBIC-ish.

=head2 L<DBIC::Manual::Cookbook>

Convenient recipes for DBIC usage.

=head2 L<DBIC::Manual::Reading>

How to read (and write) the reference documentation.

=head2 L<DBIC::Manual::DocMap>

Lists of modules by task to help you find the correct document.

=head2 L<DBIC::Manual::Troubleshooting>

Got trouble? Let us shoot it for you.

=head2 L<DBIC::Manual::Component>
