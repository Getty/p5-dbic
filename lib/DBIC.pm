...

{
  ...
  require constant;
  constant->import( DEVREL => ( ($DBIC::VERSION =~ /_/) ? 1 : 0 ) );
}
...
use base qw/DBIC::Componentised DBIC::AccessorGroup/;
use DBIC::StartupCheck;
use DBIC::Exception;

__PACKAGE__->mk_group_accessors(inherited => '_skip_namespace_frames');
__PACKAGE__->_skip_namespace_frames('^DBIC|^SQL::Abstract|^Try::Tiny|^Class::Accessor::Grouped|^Context::Preserve');
...
sub DESTROY { &DBIC::_Util::detected_reinvoked_destructor }
...
sub DBIC::_ENV_::HELP_URL () {
  'http://p3rl.org/DBIC#GETTING_HELP/SUPPORT'
}
...
See L<DBIC::Manual::DocMap> for an overview of the exhaustive documentation.
To get the most out of DBIC with the least confusion it is strongly
recommended to read (at the very least) the
L<Manuals|DBIC::Manual::DocMap/Manuals> in the order presented there.
...
=item * RT Bug Tracker: L<https://rt.cpan.org/Public/Dist/Display.html?Name=DBIC>

=item * Email: L<mailto:bug-DBIC@rt.cpan.org>
...
For the very impatient: L<DBIC::Manual::QuickStart>

This code in the next step can be generated automatically from an existing
database, see L<dbicdump> from the distribution C<DBIC-Schema-Loader>.
...
See L<DBIC::ResultSource> for docs on defining result classes.
...
=item * Current git repository: L<https://github.com/Perl5/DBIC>

=item * Travis-CI log: L<https://travis-ci.com/github/Perl5/DBIC/branches>
