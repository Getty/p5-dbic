...
plan skip_all => 'Test needs ' . DBIC::Optional::Dependencies->req_missing_for ('id_shortener')
  unless DBIC::Optional::Dependencies->req_ok_for ('id_shortener');
...
my $ROWS = DBIC::SQLMaker::ClassicExtensions->__rows_bindtype;
my $TOTAL = DBIC::SQLMaker::ClassicExtensions->__total_bindtype;

for my $q ( '', '"' ) {

  my $schema = DBICTest->init_schema(
    storage_type => 'DBIC::Storage::DBI::Oracle::Generic',
    no_deploy => 1,
    quote_char => $q,
  );
