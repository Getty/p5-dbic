...
BEGIN {
  require DBIC::Optional::Dependencies;
...
my $sqla_oracle = DBIC::SQLMaker::Oracle->new( quote_char => '"', name_sep => '.' );
isa_ok($sqla_oracle, 'DBIC::SQLMaker::Oracle');
