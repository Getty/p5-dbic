...
# --- remove_columns ---
{
  ...
  my $test_src = DBIC::ResultSource::Table->new({
    name => 'test_remove',
...
# --- related_source ---
{
  ...
  isa_ok($artist_src, 'DBIC::ResultSource', 'related_source returns RS');
...
# --- handle ---
{
  ...
  isa_ok($handle, 'DBIC::ResultSourceHandle', 'handle returns RSH');
}
