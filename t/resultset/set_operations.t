...
# --- intersect ---
{
  ...
  isa_ok($inter, 'DBIC::ResultSet', 'intersect returns RS');
...
SKIP: {
  ...
  isa_ok($inter, 'DBIC::ResultSet', 'intersect_all returns RS');
...
# --- except ---
{
  ...
  isa_ok($non_spoon, 'DBIC::ResultSet', 'except returns RS');
...
SKIP: {
  ...
  isa_ok($modern, 'DBIC::ResultSet', 'except_all returns RS');
...
# --- union_all (duplicates preserved) ---
{
  ...
  isa_ok($union, 'DBIC::ResultSet', 'union_all returns RS');
...
# --- union with array of RSes ---
{
  ...
  isa_ok($combined, 'DBIC::ResultSet', 'union with array returns RS');
...
# --- chaining: except after search ---
{
  ...
  isa_ok($result, 'DBIC::ResultSet', 'except after search works');
  my @rows = $result->all;
  for my $row (@rows) {
