...
plan skip_all => 'Test needs ' . DBIC::Optional::Dependencies->req_missing_for ('test_rdbms_informix')
  unless DBIC::Optional::Dependencies->req_ok_for ('test_rdbms_informix');
