...
warnings_like (
  ...
  [qr/Use of DBIC::UTF8Columns is strongly discouraged/],
...
cmp_ok ($test1_mro->{'A::Comp'}, '<', $test1_mro->{'DBIC::UTF8Columns'}, 'mro of Test1 correct (A::Comp before UTF8Col)' );
cmp_ok ($test1_mro->{'DBIC::UTF8Columns'}, '<', $test1_mro->{'DBIC::Core'}, 'mro of Test1 correct (UTF8Col before Core)' );
cmp_ok ($test1_mro->{'DBIC::Core'}, '<', $test1_mro->{'DBIC::Row'}, 'mro of Test1 correct (Core before Row)' );
...
warnings_like (
  ...
  [qr/Incorrect loading order of DBIC::UTF8Columns.+affect other components overriding 'store_column' \(A::Comp\)/],
...
warnings_like (
  ...
  [qr/Incorrect loading order of DBIC::UTF8Columns.+affect other components overriding 'store_column' \(A::SubComp \(via A::Comp\)\)/],
