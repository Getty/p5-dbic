...
my $page = DBIC::ResultSet::Pager->new(7, 10, 12);
isa_ok($page, 'DBIC::ResultSet::Pager');

is($page->first_page, 1, "Adjusted to first possible page");

$page = DBIC::ResultSet::Pager->new(0, 10, -1);
isa_ok($page, 'DBIC::ResultSet::Pager');

is($page->first_page, 1, "Adjusted to first possible page");

throws_ok {
  my $page = DBIC::ResultSet::Pager->new(12, -1, 1);
  }
