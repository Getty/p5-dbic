...
DBIC::Test::SQLite - Base class for running Class::DBI tests against DBIC compat layer, shamelessly ripped from Class::DBI::Test::SQLite
...
This provides a simple base class for DBIC::CDBICompat tests using
...
This combines creating the table with the normal DBIC table()
call.
