...
isa_ok($art, 'DBIC::ResultSet', 'get a DBIC::ResultSet object');
my $next = $art->next;
...
warnings_exist {
  $artist_rs->find({})
} qr/\QDBIC::ResultSet::find(): Query returned more than one row/, "Non-unique find generated a cursor inexhaustion warning";
