...
DBICTest - Library to be used by DBIC test scripts
...
=head2 init_schema
  ...
  my $schema = DBICTest->init_schema(
    ...
    storage_type_args=>{
      balancer_type=>'DBIC::Storage::DBI::Replicated::Balancer::Random'
    },
  );
