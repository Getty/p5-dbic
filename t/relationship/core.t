...
isa_ok( $rs_from_list, 'DBIC::ResultSet', 'search_related_rs in list context returns rs' );

( $rs_from_list ) = $artist->cds_rs();
isa_ok( $rs_from_list, 'DBIC::ResultSet', 'relation_rs in list context returns rs' );
