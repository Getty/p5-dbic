...
BEGIN {
    require DBIC;
    plan skip_all => 'Test needs ' . DBIC::Optional::Dependencies->req_missing_for ('test_prettydebug')
      unless DBIC::Optional::Dependencies->req_ok_for ('test_prettydebug');
}
...

{
   ...
   isa_ok($schema->storage->debugobj, 'DBIC::Storage::Statistics');
}

{
   ...
   isa_ok($schema->storage->debugobj, 'DBIC::Storage::Debug::PrettyTrace');;
