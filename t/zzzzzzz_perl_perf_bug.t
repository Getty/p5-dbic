...
# It does not test any aspect of DBIC, but instead tests the
...
cmp_ok( $ratio, '<', $fail_ratio, 'Overload/bless performance acceptable' )
  || diag(
    ...
    "the performance of DBIC programs.  Please read the section\n",
...
SKIP: {
    ...
    # DBIC (and many other) modules.  Look at getting a fixed
