...
plan skip_all => 'Test needs ' . DBIC::Optional::Dependencies->req_missing_for ('test_rdbms_mssql_ado')
  unless DBIC::Optional::Dependencies->req_ok_for ('test_rdbms_mssql_ado');
...
isa_ok($schema->storage, 'DBIC::Storage::DBI::ADO::Microsoft_SQL_Server');
