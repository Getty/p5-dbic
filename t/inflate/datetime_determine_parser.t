...
plan skip_all => 'Test needs ' . DBIC::Optional::Dependencies->req_missing_for ('test_dt_sqlite')
...
is(
    ref $schema->storage, 'DBIC::Storage::DBI',
...
isa_ok($schema->storage, 'DBIC::Storage::DBI::SQLite', 'storage');
