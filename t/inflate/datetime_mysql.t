...
plan skip_all => 'Inflation tests need ' . DBIC::Optional::Dependencies->req_missing_for ('test_dt_mysql')
  unless DBIC::Optional::Dependencies->req_ok_for ('test_dt_mysql');
...
foreach my $tbl (qw/EventTZ EventTZDeprecated/) {
  ...
  SKIP: {
    ...
    warnings_exist (
      ...
      qr/You're using a floating timezone, please see the documentation of DBIC::InflateColumn::DateTime for an explanation/,
