...
plan skip_all => 'Test needs ' . DBIC::Optional::Dependencies->req_missing_for ('test_rdbms_mssql_odbc')
  unless DBIC::Optional::Dependencies->req_ok_for ('test_rdbms_mssql_odbc');
...
isa_ok( $schema->storage, 'DBIC::Storage::DBI::ODBC::Microsoft_SQL_Server' );
